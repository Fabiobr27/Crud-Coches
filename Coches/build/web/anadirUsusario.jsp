<%-- 
    Document   : anadirUsusario
    Created on : 30-may-2019, 8:52:13
    Author     : FABIO
--%>
...
<html>
    ...
    <body>
        ...
        <<table class="container">
            ...
            <form method="get" action="modificaAdmin.jsp">

                <th><input type="hidden" name="id" value="<%= estado.equals("edicion") ? request.getParameter("id") : ""%>"/></th>



                <th><input type="text" name="usuario" value="<%= estado.equals("edicion") ? request.getParameter("usuario") : ""%>"/></th>
                <th><input type="text"  name="contrasena"  value="<%= estado.equals("edicion") ? request.getParameter("contrasena") : ""%>"/></th>
            ...
            <td>
                ...
                <form method="get" action="BorrarAdmin.jsp">
                    ...
                    <form method="get" action="anadirUsusario.jsp">
    ...
    <div class="wrapper">
        ...
        <!-- Formulario -->
        <form action="nuevoAdmin.jsp" method="post" class="login">
            <h2>Inserta nuevo Admin </h2>
